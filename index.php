...
<head>
	...
	.trigger-btn {
		...
		.modal-confirm .icon-box-red i {
		font-size: 58px;
		position: relative;
		top: 3px;
	}
	.modal-confirm .icon-box-red {
		color: #fff;		
		position: absolute;
		margin: 0 auto;
		left: 0;
                ...
                <div class="row">
                    ...
                    <div class="col-xs-10 text-right  menu-1 main-nav">
                        <div class="col-md-10  menu-1 main-nav">
                            <ul>
                                <li class="active">
                                    <a href="#" data-nav-section="home">Hasiera</a>
                                </li>
                                <li>
                                    <a href="#" data-nav-section="about">Nortzuk gara</a>
                                </li>
                                <li>
                                    <a href="#" data-nav-section="photos">Argazkiak</a>
                                </li>
                                <li class="btn-cta">
                        ...
                        <div class="display-t">
                            <div class="display-tc">
                                ...
                                <p class="gtco-video-link animate-box" data-animate-effect="fadeIn">
                                    <a data-toggle="modal" data-target="#myModal" class="popup-vimeo">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 animate-box" data-animate-effect="fadeInLeft">
                        ...
                        <p>Bi zutabe nagusitan oinarritzen da Dorronsoro okindegia: kalitatean eta zerbitzuan. Hori dela-eta,
                            lehen mailako lehengaiak erabiltzen ditu bere produktuak egiteko, masa izoztuak edota aurrez
                            egositako ogiak bezalako irtenbide azkarrak saihestu eta egunean egunekoari arretaz eta mimo
                            handiz erantzunez. Bezeroen premiei erantzutea da erronka nagusia, bakoitzak dituen beharrei
                            egokitzea, kalitatea duten produktuei garrantzia emanez eta gertuko zerbitzu ezin hobea eta azkarra
                            eskainiz. Bere txikian, beraz, desafio handiak ditu Dorronsoro okindegiak, prezioen konpetentzia
                            handiari erantzuteko modu bakarra ezagutzen baitu: kalitatea. Ogiak duen prozesua ikusi nahi?
                            azpian duzu laburpen txiki bat.</p>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6 col-md-push-6 animate-box">
                        <form action="#" method="post" enctype="text/plain" name="mezua_bidali">
                    ...
                    <div class="col-md-4 col-md-pull-6 animate-box">
                        <div class="gtco-contact-info">
                            <ul>
                                <li>
                                    <span class="fa fa-map-marker heading-colored"></span>
                                    <a href="https://www.google.es/maps/place/IES+Uni+Eibar-Ermua+BHI" target="blank">
                                        Gipuzkoa, Eibar 48260</a>
                                </li>
                                <li>
                                    <span class="fa fa-phone heading-colored"></span>
                                    <a href="tel://943208444"> 943 20 84 44</a>
                                </li>
                                <li>
                                    <span class="fa fa-envelope heading-colored"></span>
                                    <a href="mailto:dw3-2-10.17@uni.eus"> info@migasamigas.com</a>
                                </li>
                                <li>
                                    <span class="fa fa-globe heading-colored"></span>
                                    <a href="https://migasamigas-bittorpoza.c9users.io/index.html"> https://migasamigas.com</a>
                                </li>
                            </ul>
                        </div>
                    </div>
	...
	<div class="modal-dialog modal-confirm">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Oso ondo!</h4>	
			</div>
			<div class="modal-body">
				<p class="text-center">Zure eskakizuna burutu da.</p>
			</div>
		</div>
	</div>
</div>    
...
<div id="noOk" class="modal fade">
	<div class="modal-dialog modal-confirm">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Errorea!</h4>	
			</div>
			<div class="modal-body">
				<p class="text-center">Arazo bat gertatu da zure eskakizunarekin.</p>
			</div>
		</div>
	</div>
</div>   
    ...
    <script type="text/javascript">
            ...
            switch (id) {
                case '1':
                    ...
                    document.getElementById("product_description").innerHTML =
                        'Zapore handiko moldeko ogia, gosarietan hartzeko aproposa.';
                    break;
                case '2':
                    document.getElementById("product_title").innerHTML = 'SESAMODUNA OGIA';
                    document.getElementById("product_description").innerHTML =
                        'Ogi oso osasuntsua, magnesioan eta fosforoan aberatsa.';
                    break;
                case '3':
                ...
                case '4':
                    ...
                    document.getElementById("product_description").innerHTML =
                        'Hirin integraleko ogia Oloarekin, osasuntsua eta oso goxoa.';
                    break;
                case '5':
                    document.getElementById("product_title").innerHTML = 'MOLDEKO OGI TXURIA';
                    document.getElementById("product_description").innerHTML =
                        'Gosariak edo sandwichak egiteko aproposa, kontserbante eta aditiborik gabe.';
                    break;
                case '6':
                    document.getElementById("product_title").innerHTML = 'OGI ERROMATARRA';
                    document.getElementById("product_description").innerHTML =
                        'Ogi kurruskaria mozketarik gabe azalean.';
                    break;
                default:
                    // code
            }
        ...
        var image;
        var fullImage =
            "<div class='col-md-6 animate-box' data-animate-effect='fadeInRight'><div class='img-shadow'><img src='images/1.png' onclick='aldatu(this.id)' data-toggle='modal' data-target='#product_view' class='img-responsive' alt='migasamigas' id=1></div></div>";
        for (var a = 2; a <= 6; a++) {

            if (a % 2 != 0) {
                image =
                    "<div class='col-md-6 animate-box' data-animate-effect='fadeInRight'><div class='img-shadow'><img src='images/" +
                    a +
                    ".png' onclick='aldatu(this.id)' data-toggle='modal' data-target='#product_view' class='img-responsive' alt='migasamigas' id=" +
                    a + "></div></div>";
                fullImage = fullImage + image;
                console.log("bikoiti");
            } else {
                image =
                    "<div class='col-md-6 animate-box' data-animate-effect='fadeInLeft' style='margin-bottom:3%'><div class='img-shadow'><img src='images/" +
                    a +
                    ".png' onclick='aldatu(this.id)' data-toggle='modal' data-target='#product_view' alt='migasamigas'class='img-responsive' id=" +
                    a + "></div></div>";
                fullImage = fullImage + image;
                console.log("Bakoiti");
            }
    ...
    <script>
       $(document).ready(function () {
        $(function () {
            ...
            $("form[name='mezua_bidali']").validate({
                ...
                messages: {
                    name: "Sartu zure izena.",
                    messages: "Sartu mezua mesedez.",
                    email: "Sartu email egoki bat."
                },
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        if (result == "Mezua bidalita!") {
                        	$("#ok").modal('show');
                        //	alert(result);
                           // alert("Mezua bidalita, lehen bai lehen erantzungo dizuegu :)");
                        } else {
                        	//alert(result);
                        	$("#noOk").modal('show');
                           // alert("Errore bat egon da mezua bidaltzerakoan, barkatu eragozpenak :(" );
                        }
